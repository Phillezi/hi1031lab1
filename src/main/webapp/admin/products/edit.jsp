...
<div class="container">
    <div class="modal-overlay">
        <div class="modal">
            ...
            <form action="${pageContext.request.contextPath}/controller?action=products&operation=update" method="post">
                ...
                <textarea name="description" id="description" rows="5" required><%= product.getDescription() %></textarea>
                <br/>
                ...
                <table style="display: none;">
                    ...
                    %>
                    <tr>
                        <td><%= property.getKey() %></td>
                        <td><input type="text" name="property_<%= property.getKey() %>" value="<%= property.getValue() %>"/></td>
                    </tr>
                    <%
                        }
                    } else {
