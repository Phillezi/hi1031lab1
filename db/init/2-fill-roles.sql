INSERT INTO available_permissions (name, description)
VALUES ('administrate', 'Permission to administer the system'),
       ...
       ('change_categories', 'Permission to change product categories'), -- Permission to change categories
       ('change_products', 'Permission to change product details'); -- Permission to change product details

INSERT INTO available_roles (name, description)
VALUES ('admin', 'Administrator with full rights'),
       ('warehouse', 'Warehouse staff with permission to pack orders and view inventory'),
       ('customer', 'Customer with permission to place orders and view their own information');

INSERT INTO permissions_t (role, permission)
VALUES ('admin', 'administrate'),
       ('admin', 'edit_products'),
       ('admin', 'add_products'),
       ('admin', 'update_orders'),
